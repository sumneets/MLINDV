...
path = '~/Desktop/MLINDIV/mvpa/results/decision_making_direction'

exploration <- read_csv(paste0(path,'/decision_point_allo_explore.csv'))
...
exploration_rand <- read_csv(paste0(path,'/decision_point_allo_explore_rand.csv'))
...
test <- read_csv(paste0(path,'/decision_point_allo_test.csv'))
test_rand <- read_csv(paste0(path,'/decision_point_allo_test_rand.csv'))
...
#mean20 <- cbind(exp_mean, exp_se, exploration_rand)
#colnames(mean20) <- c('Exploration','Explore_se', 'Explore_rand')
